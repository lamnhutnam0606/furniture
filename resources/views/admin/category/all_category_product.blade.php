        ...
        <table class="table table-striped b-t b-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ URL::to('update-category-product/'.$cate->category_id) }}" class="active" ui-toggle-class="">
                  <i class="fa fa-pencil-square-o text-success text-active"></i>
                </a>
                <a onclick="return confirm('Are you sure you want to delete this category?')" href="{{ URL::to('delete-category-product/'.$cate->category_id) }}" class="active" ui-toggle-class="">
