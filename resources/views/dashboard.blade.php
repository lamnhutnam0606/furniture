...
<meta name="select-feeship-url" content="{{ url('/select-feeship') }}">
...
<style>
    ...
    position: sticky;
    top: 0;
    z-index: 1; /* Đảm bảo phần thead hiển thị trên cùng */
}
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('resources/images/3.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('resources/images/1.png')}}"></span>
                                <span class="subject">
                                <span class="from">Nam</span>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{asset('resources/images/2.png')}}">
                <span class="username">
                    <?php
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-category-product')}}">Details Info Category</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-brand-product')}}">Details Info Brand</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/show-add-product')}}">Add Product</a></li>
						<li><a href="{{URL::to('/all-product')}}">Details Info Producta</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/show-add-coupon')}}">Add Coupon</a></li>
						<li><a href="{{URL::to('/list-coupon')}}">Details Info Coupon</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //fee_feeship_edit ở dòng 70 file DeliveryController
        // $(document).on('blur','.fee_feeship_edit',function(){
        //     var feeship_id = $(this).data('feeship_id');//feeship_i dở dòng 70 file DeliveryController
        ...
        //         success:function(data){
        //             alert('Update shipping fee successfully!');
        //             fetch_delivery();
        ...
        $('.add_delivery').click(function(){
            ...
            $.ajax({
                ...
                method : 'POST',
                data:{city:city,district:district,wards:wards,feeship:feeship,_token:_token},
                success:function(data){
                    alert('Add shipping fee successfully!');
                    location.reload();
                    fetch_delivery();
